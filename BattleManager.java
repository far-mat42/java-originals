...
public class BattleManager {
	...
	public static final int NUM_PLAYERS =21;
	...
	public static void main(String[] args) {
		...
		if (health[16] != 0 || health[17] != 0 || health[18] != 0) {
			System.out.println("\n\n\nVictory!");
			
			if (health[16] > 0) {
				System.out.println("Final health: "+health[16]+"\nFinal energy level: "+energy[16]);
			}
			else if (health[17] > 0) {
				System.out.println("Final health: "+health[17]+"\nFinal energy level: "+energy[17]);
			}
			else if (health[18] > 0) {
				System.out.println("Final health: "+health[18]+"\nFinal energy level: "+energy[18]);
			}
		...
		System.out.println("Master Robot's Stats: ");
		System.out.println((stats[16].getFightsInitiatedWin()+stats[17].getFightsInitiatedWin()+stats[18].getFightsInitiatedWin())+" attacks won");
		System.out.println((stats[16].getFightsInitiatedLoss()+stats[16].getFightsInitiatedTie()+stats[17].getFightsInitiatedLoss()+stats[17].getFightsInitiatedTie()+stats[18].getFightsInitiatedLoss()+stats[18].getFightsInitiatedTie())+" attacks lost/tied");
		System.out.println((stats[16].getFightsDefendWin()+stats[17].getFightsDefendWin()+stats[18].getFightsDefendWin())+" defences won");
		System.out.println((stats[16].getFightsDefendLoss()+stats[16].getFightsDefendTie()+stats[17].getFightsDefendLoss()+stats[17].getFightsDefendTie()+stats[18].getFightsDefendLoss()+stats[18].getFightsDefendTie())+" defences lost/tied");
		System.out.println((stats[16].getNumPenalties()+stats[17].getNumPenalties()+stats[18].getNumPenalties())+" penalties received");
		System.out.println((stats[16].getNumKills()+stats[17].getNumKills()+stats[18].getNumKills())+" robots killed");
	}
	...
	private static void createPlayers()
	{
		...
		player[0] = new TitanFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 0, MAX_HEALTH);
		player[1] = new TitanFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 1, MAX_HEALTH);
		player[2] = new EdgeRunnerBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 2, MAX_HEALTH);
		player[3] = new EdgeRunnerBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 3, MAX_HEALTH);
		player[4] = new TankFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 4, MAX_HEALTH);
		player[5] = new TankFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 5, MAX_HEALTH);
		player[6] = new DummyBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 6, MAX_HEALTH);
		player[7] = new FencingFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 7, MAX_HEALTH);
		player[8] = new TitanFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 8, MAX_HEALTH);
		player[9] = new DefectiveBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 9, MAX_HEALTH);
		player[10] = new EdgeRunnerBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 10, MAX_HEALTH);
		player[11] = new DefectiveBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 11, MAX_HEALTH);
		player[12] = new TankFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 12, MAX_HEALTH);
		player[13] = new DummyBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 13, MAX_HEALTH);
		player[14] = new FencingFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 14, MAX_HEALTH);
		player[15] = new DummyBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 15, MAX_HEALTH);
		player[16] = new MasterFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 16, MAX_HEALTH);
		player[17] = new MasterFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 17, MAX_HEALTH);
		player[18] = new MasterFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 18, MAX_HEALTH);
		player[19] = new FencingFighterBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 19, MAX_HEALTH);
		player[20] = new DefectiveBot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.NORTH, 20, MAX_HEALTH);
